            ...
            <div class="container">
                <div class="row">
                        ...
                        <el-card class="box-card p-0 card">
                              <div class="card-header p-0 mb-2" style="">
                                ...
                                <el-button style=" float: right;border: 0px;">
                                  举报<el-icon><WarnTriangleFilled /></el-icon>
                                </el-button>
                    ...
                    <div class="col-2">
                      ...
                      <div class="button-area">
                        <el-button color="#45454A" style=" color:aliceblue; border:0px;width:125px;">
                          加入收藏<el-icon class="el-icon--right"><Star /></el-icon>
                        </el-button>
                      </div>

                      <div class="button-area">
                        <el-button color="#45454A" style=" color:aliceblue; border:0px;width:125px;">
                          立即沟通<el-icon class="el-icon--right"><ChatDotRound /></el-icon>
                        </el-button>
                      </div>

                      <div class="button-area">
                        <el-button color="#45454A" style="color:aliceblue; border:0px;width:125px;">
                          分享<el-icon class="el-icon--right"><Share /></el-icon>
                        </el-button>
                      </div>     
                    </div>
