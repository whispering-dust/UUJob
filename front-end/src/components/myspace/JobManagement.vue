<template>
    <el-container style="height:100% width:100%">
        ...
        <!-- 简历列表 -->
        <el-main>
          <el-card v-if="selectedJob.title" class="box-card p-0 " shadow="never" :body-style="{ padding: '0px', height: '100%' }">
                    ...
                    <div class="profile-list">
                        <el-tabs v-model="activeName" @tab-change="handleChange" class="demo-tabs m-3" stretch="true">
                            <el-tab-pane label="未审核" name="first" >
                                <el-list>
                                    <el-list-item
                                      v-for="profile in unreviewedProfile"
                            ...
                            <el-tab-pane label="已通过" name="second">
                                <el-list>
                                    <el-list-item
                                      v-for="profile in reviewedProfile"
                                      :key="profile.profileId"
                                      @click="selectProfile(profile.profileId)"
                                    >
                                    <el-card
